<template>
    <div>
        ...
        <div v-if="!loaded" style="height: 100%; width: 100%; position: fixed; z-index: 10; top: 0; background-color: rgba(0, 0, 0, 0.5); left: 0;"></div>
    ...
    data() {
        return {
            ...
            personsOptions: [
                ...
                { value: '2', text: '2 персони' },
                { value: '3', text: '3 персони' },
                { value: '4', text: '4 персони' },
                { value: '5', text: '5 персон' },
                { value: '6', text: '6 персон' },
                { value: '7', text: '7 персон' },
            ],
            sticksOptions: [
