                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="form-group py-4">
                        ...
                        <div v-if="errors && errors.avatar">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.avatar[0] }}</b-alert>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.name">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.name[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.email">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.email[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.phone">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.phone[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.gender">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.gender[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.current_password">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.current_password[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.password">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.password[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="errors && errors.password_confirmation">
                            <b-alert variant="danger" dismissible fade :show="true">{{ errors.password_confirmation[0] }}</b-alert>
                        </div>
                    </div>
                    <div class="form-group">
