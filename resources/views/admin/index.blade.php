                ...
                <div class="py-4 bg-white border rounded border-light shadow">
	            	...
	            	<div class="container">
	                    <div class="row justify-content-center">
	                        ...
	                        <div class="col-12 col-md-6 my-2">
	                            <div class="card h-100 shadow">
	                                <a class="card-link text-secondary p-1" href="{{route('admin.discounts.index')}}">
	                                	<h1 class="display-1 text-center"><i class="fas fa-percent"></i></h1>
	                                    <h4 class="text-center text-uppercase">Знижки</h4>
	                                </a>
	                            </div>
	                        </div>
	                        <div class="col-12 col-md-6 my-2">
	                            <div class="card h-100 shadow">
	                                <a class="card-link text-secondary p-1" href="{{route('admin.galleries.index')}}">
	                                	<h1 class="display-1 text-center"><i class="far fa-images"></i></h1>
	                                    <h4 class="text-center text-uppercase">Галереї</h4>
	                                </a>
	                            </div>
	                        </div>
	                        <div class="col-12 col-md-6 my-2">
	                            <div class="card h-100 shadow">
	                                <a class="card-link text-secondary p-1" href="{{route('admin.users.index')}}">
	                                    ...
	                                    <h4 class="text-center text-uppercase">Користувачі</h4>
	                                </a>
	                            </div>
	                        </div>
	                    </div>
